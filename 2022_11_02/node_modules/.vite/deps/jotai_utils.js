import {
  atom,
  getScopeContext,
  registerPromiseAbort,
  useAtom,
  useAtomValue,
  useSetAtom
} from "./chunk-GD36XXQS.js";
import {
  require_react
...
function useResetAtom(anAtom, scope) {
  ...
  const store = (0, import_react.useContext)(ScopeContext).s;
...
var unwrapAtoms = (atoms) => Array.isArray(atoms) ? atoms : Object.getOwnPropertyNames(atoms).map((key) => atoms[key]);
var wrapResults = (atoms, results) => Array.isArray(atoms) ? results : Object.getOwnPropertyNames(atoms).reduce(
